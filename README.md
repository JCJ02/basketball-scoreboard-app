...
3. Shot Clock: Manages the shot clock to ensure teams shoot within the required time limit.
4. Quarter or Half Display: Indicates the current quarter (e.g., 1st, 2nd, 3rd, or 4th) or half of the game.
5. Fouls and Timeouts: Tracks the number of fouls per team and available timeouts.
6. Controller: Enables control of the scoreboard within the app.

## Technologies and Tools I used to develop this application.
### Technologies
- JavaScript (React.js)
- HTML
- CSS (Tailwind CSS)
